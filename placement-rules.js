...
const PLACEMENT_RULES = {
    ...
    'path': ['path', 'garrison', 'armoury', 'spymaster', 'legion_barrack', 'commander', 'synthflesh_lab', 'transcendent_barracks', 'alchemy_lab', 'smithy', 'sacrificial_chamber', 'thaumaturge', 'golem_works', 'corruption_chamber', 'generator', 'flesh_surgeon', 'architect'],
    'architect': ['path', 'garrison', 'armoury', 'spymaster', 'legion_barrack', 'commander', 'synthflesh_lab', 'transcendent_barracks', 'alchemy_lab', 'smithy', 'sacrificial_chamber', 'thaumaturge', 'golem_works', 'corruption_chamber', 'generator', 'flesh_surgeon', 'architect']
};
